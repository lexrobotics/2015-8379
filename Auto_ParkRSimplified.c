...
task main()
{
	...
	move(100.0,66.0);//**2nd length: move toward the ramp
	...
	move(100.0,64.0);//**3rd length: move toward the goal
	move(60.0, 14.0);//**length: slow down and approach the goal
	...
	move(-100.0,5.0);// **length: back away a little
