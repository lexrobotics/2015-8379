...
//version 12/16/14 hood part added
...
task main()
{
	...
	turnWithGyro(-100.0, 70.0);//1st turn: turn to face rolling goal
	move(100.0, 50.0);
	...
	turnWithGyro(-100.0,170.0);//turn back to straight
	...
	**********************************************************/
	int totaltime = 20;
	wait1Msec((27-totaltime-delay)*1000);
	pos3 = 10;
