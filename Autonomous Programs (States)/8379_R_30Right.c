...
task main()
{
	...
	mecMove(80, 0, 0, 170);//**1st length: move down the ramp
	wait1Msec(250);
	mecMove(-80, 90, 0,  47.0);//strafe left
	//turnMecGyro(60.0,3.0);
	wait1Msec(250);
	...
	mecMove(-80, 90, 0,  5.0);//strafe left a bit

	motor[Flipper] = -100.0; //start thrower motor

	mecMove(-80.0, 0, 0, 260.0);//**length: move pass the kick stand
	wait1Msec(250);
	mecMove(-80.0, 90, 0, 120.0);//left strafe again
	wait1Msec(250);
	turnMecGyro(-60.0,135.0);//turn toward the PK
	mecMove(80, 0, 0, 10);
