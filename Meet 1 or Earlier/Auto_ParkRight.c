...
void move(float speed, float distance)
{
	...
	while(nMotorEncoder[motorLeft] <= encoderScale * (distance / wheelCircumference) )
	{
	}
	motor[motorLeft] = 0;
	motor[motorRight] = 0;
...
task main()
{
	...
	turnWithGyro(-100, 10.0);//turn towards goal
	...
	{
		//motor[motorLeft] = 60*(encoderScale * (28.0 / wheelCircumference)-nMotorEncoder[motorLeft];
		//motor[motorRight] = 60*(encoderScale * (28.0 / wheelCircumference)-nMotorEncoder[motorRight];
	}
	motor[motorLeft] = 0;
	motor[motorRight] = 0;
	wait1Msec(10);
	...
	turnWithGyro(-100,172.0);//turn back to parking zone
	...
	while(abs(nMotorEncoder[motorLeft]) <= encoderScale * 2 * (75.0 / wheelCircumference) ) // move forward 80 cm
	{
	}
	resetEncoders();
	...
	motor[motorLeft] = 100;
	motor[motorRight] = 100;
	while(nMotorEncoder[motorLeft] <= encoderScale * (130.0 / wheelCircumference) )	//approach parking zone
	{
	}
	motor[motorLeft] = 0;
	motor[motorRight] = 0;
	...
	motor[motorLeft] = 100;
	motor[motorRight] = 100;
	while(nMotorEncoder[motorLeft] <= encoderScale * (20.0 / wheelCircumference) )	//go into parking zone
	{
	}
	motor[motorLeft] = 0;
	motor[motorRight] = 0;
