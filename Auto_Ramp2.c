...
task main()
{
	...
	turnWithGyro(-100,125.6);//turn 125 degrees toward the parking zone
	resetEncoders();
	...
	while(abs(nMotorEncoder[motorLeft]) <= encoderScale * 2 * (112.0 / wheelCircumference) ) // move forward 281 cm
	{
	}
	resetEncoders();
