...
task main()
{
	...
	mecMove(80, 90, 0, 3);//translate forward off wall
	mecMove(80, 0, 0, 200);//shift left and disturb goals
	mecMove(80, 120, 0, 150);//shift forward at angle into bottle neck
